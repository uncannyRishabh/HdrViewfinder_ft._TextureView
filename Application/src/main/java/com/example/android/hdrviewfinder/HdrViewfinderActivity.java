 ...
 */
public class HdrViewfinderActivity extends AppCompatActivity implements CameraOps.ErrorDisplayer, CameraOps.CameraReadyListener {
...
//    private FixedAspectSurfaceView mPreviewView;
    private AutoFitPreviewView mPreviewView;
...
//                                intent.setData(uri);
    ...
    private void configureSurfaces() {
        ...
        mPreviewView.setAspectRatio(outputSize.getWidth(),outputSize.getHeight());
        mPreviewView.measure(outputSize.getWidth(),outputSize.getHeight());
...
//        mPreviewView.getHolder().setFixedSize(outputSize.getWidth(), outputSize.getHeight());
    ...
    private void setupProcessor() {
        ...
        mProcessor.setOutputSurface(new Surface(mPreviewSurface));
